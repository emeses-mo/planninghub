...
import './SD_ApprovedServices.css'
function SD_ApprovedServices() {
    ...
    useEffect(() => {
        auth.onAuthStateChanged((authUser)=>{
            ...
            db.collection(an).where('Verified','==','Yes').onSnapshot((querySnapshot)=>{
                const items=[]
                querySnapshot.forEach((doc)=>{
                    items.push(doc.data())
                })
...
export default SD_ApprovedServices
